# Freeciv(classic) · terrain

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/classic/terrain.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, classic

## 概述
Freeciv classic规则集的terrain定义
...
[datafile]
description="Classic tile_type data for Freeciv21"
...
Glaciers are found only in the most northerly or southerly\
 ...
 work with.\
"), _("\
Oil wells can be built when Refining is discovered.\
")
...
"), _("\
Oil wells can be built when Construction is discovered.\
")
...
3 production points per tile and other terrains get 1 extra production \
point.\
"), _("\
...
moving recovers a quarter of its hitpoints. With Invention, fortresses \

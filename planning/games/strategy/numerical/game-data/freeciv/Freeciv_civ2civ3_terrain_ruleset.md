# Freeciv(civ2civ3) · terrain

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2civ3/terrain.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2civ3

## 概述
Freeciv civ2civ3规则集的terrain定义
...
[datafile]
description="Civ2Civ3 tile_type data for Freeciv21"
...
cooler_wetter_result = "no"
cooler_drier_result  = "no"
native_to            = "Land", "Small Land", "Merchant", "Big Land", "Air", "Missile", "Helicopter"
...
Cities built in hills are at risk of earthquakes, which can interrupt\
 a city's current production target.\
")
...
"), _("\
Building irrigation on a tile with a mine or oil well will destroy the mine.\
"), _("\
...
whole turn without moving recovers a tenth of its hit points. This is, \
...
Roads allow your land units to move more quickly, and allow wheeled\
 ...
 otherwise difficult terrain such as Mountains, Jungle, and Swamp.\
"), _("\
...
Roads and railroads can only be built on River tiles if your\
 civilization has learned the Bridge Building technology. Fortresses and\

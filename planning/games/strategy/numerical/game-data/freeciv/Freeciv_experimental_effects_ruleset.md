# Freeciv(experimental) · effects

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/experimental/effects.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, experimental

## 概述
Freeciv experimental规则集的effects定义
...
[datafile]
description="Experimental effects data for Freeciv21"
options="+Freeciv-ruleset-Devel-2017.Jan.02 +HP_Regen_Min +Bombard_Limit_Pct +Vision_Layer +Nation_Intelligence +Per_Citizen_Unhappy_Pct"
format_version=20
...
[effect_enemy_unhappiness_communism]
type    = "Per_Citizen_Unhappy_Pct"
value   = -50
reqs	=
    { "type", "name", "range"
...
[effect_enemy_unhappiness_republic]
type    = "Per_Citizen_Unhappy_Pct"
value   = -50
reqs	=
    { "type", "name", "range"
...
[effect_enemy_unhappiness_democracy]
type    = "Per_Citizen_Unhappy_Pct"
value   = -67
reqs	=
    { "type", "name", "range"
...
[effect_genetic_lab_health]
type   = "Health_Pct"
value  = 20
reqs   =
    {"type", "name", "range"
     "Building", "Genetic Lab", "City"
    }

[effect_genetic_lab_food]
type    = "Output_Bonus"
value	= 25
reqs	=
    { "type", "name", "range"
...
; City radius 2 - radius is sqrt(2+3) = 2.24
...
; City radius 3 - radius is sqrt(2+3+5) = 3.16

# Freeciv(nation) · veletian

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/nation/veletian.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, nation

## 概述
Freeciv nation规则集的veletian定义
...
name=_("Veletian")
plural=_("?plural:Veletians")
groups="European", "Medieval"
legend=_("The Veletians or Lutici were a medieval West Lechitic tribal\
...
conflicts_with="mecklenburgian", "brandenburgian", "german", "east german", "slavic"
civilwar_nations = "western pomeranian", "sorbian" ; rugian polanian obrodite

cities =
 "Brenna",                    ; Branibor/Brandenburg
 "Dimin",                     ; Demmin
 "Berlin",
 "Kopanik",                   ; Köpenick
 "Hobolin",                   ; Havelberg
 ...
 "Lubuš",                     ; Lubusz
 "Losowo",                    ; Lossow
 "Rajtwinoj",                 ; Rytwiny/Reitwein
 "Trebin",                    ; Neutrebbin
 "Bukow",                     ; Buckow
 "Lemerice",                  ; Lemierzyce
 "Pręclaw",                   ; Prenzlau
 "Pozdawolk",                 ; Pasewalk
 "Wkrajust'e",                ; Wkryujście
 "Prignica"                   ; Prignitz

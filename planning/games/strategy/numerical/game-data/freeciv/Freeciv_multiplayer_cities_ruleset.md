# Freeciv(multiplayer) · cities

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/multiplayer/cities.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, multiplayer

## 概述
Freeciv multiplayer规则集的cities定义
...
[datafile]
description="Cities data for Freeciv21"
...
helptext        = _("\
Each scientist adds three bulbs to your empire's research output \
per turn.\
")
...
helptext        = _("\
Each tax collector produces three extra gold for your national treasury \
per turn.\
")

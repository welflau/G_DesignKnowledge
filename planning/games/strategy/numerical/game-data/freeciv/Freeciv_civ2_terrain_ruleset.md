# Freeciv(civ2) · terrain

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/terrain.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的terrain定义
...
[datafile]
description="Civ2 tile_type data for Freeciv21"
...
flags                = "NoBarbs", "CanHaveRiver", "Frozen"
property_frozen      = 100
color.r              = 232
color.g              = 232
color.b              = 232
...
"), _("\
Building irrigation on a tile with a mine will destroy the mine.\
"), _("\
...
global warming.\
"), _("\
The pollution can only be cleared by dispatching Settlers or Engineers \
...
food.\
"), _("\
Like irrigation, farmland is incompatible with mines.\
")
...
"), _("\
Furs, when found on a Tundra tile, gives 1 more food and 1 more trade.\
 For more information, review the help for the individual tile type.\
")
...
"), _("\
Oil, when found on a Glacier tile, gives 4 more shields.\
 For more information, review the help for the individual tile type.\
")
...
The discovery of oil and the production of fuel and other derivative\
 petroleum products has revolutionized the modern world.\
"), _("\
Oil, when found on a Desert tile, gives 3 more shields.\
 For more information, review the help for the individual tile type.\
")

# Freeciv(experimental) · units

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/experimental/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, experimental

## 概述
Freeciv experimental规则集的units定义
...
[datafile]
description="Experimental unit data for Freeciv21"
...
veteran_base_raise_chance      = 0, 0, 0
...
Equipped with long pikes, Pikemen replaces Phalanx\
 as the preferred city defender. Mounted units have a\
 disadvantage against Pikemen.\
")
...
movement points can paradrop directly to any tile in range (even onto \
ships), and be immediately ready to act there. (Beware dropping into \
unseen territory, as Paratroopers landing on a tile occupied by enemy \
units are easy targets!)\
")
...
uk_gold       = 0
flags         = "Horse"
roles         = "AttackFastStartUnit", "BarbarianBuildTech",
                "BarbarianSeaTech", "Hunter"
helptext      = _("\
...
flags         = "AirAttacker", "Shield2Gold"
roles         = ""
helptext      = _("\
Fighters are your first airborne units. They can\
 move anywhere and attack any unit. Fighters have a\
 disadvantage againt Helicopters.\
")
...
uk_food       = 0
uk_gold       = 0
flags         = "FieldUnit", "OneAttack", "AirAttacker", "Shield2Gold",
                "HasNoZOC"
roles         = ""
helptext      = _("\
...
uk_food       = 0
uk_gold       = 0
flags         = "FieldUnit", "OneAttack", "Helicopter", "AirAttacker", "Shield2Gold"
roles         = ""
helptext      = _("\
...
An improved Fighter, with improved attack and a higher movement\
 radius. Stealth Fighters have a disadvantage againt Helicopters.\
")
...
uk_gold       = 0
cargo         = "Land"
flags         = "BadCityDefender", "Provoking", "Provoking"
...
uk_gold       = 0
cargo         = "Land", "Big Land"
flags         = "BadCityDefender", "Provoking"
roles         = "Ferryboat", "FerryStartUnit", "BarbarianBoat"
helptext      = _("\
...
flags         = "BadCityDefender", "Only_Native_Attack", "Shield2Gold",
                "Provoking"
roles         = ""
helptext      = _("\
...
uk_gold       = 0
cargo         = "Land", "Big Land"
flags         = "BadCityDefender", "Shield2Gold", "Provoking"
roles         = "Ferryboat", "FerryStartUnit"
helptext      = _("\
...
uk_food       = 0
uk_gold       = 0
flags         = "FieldUnit", "OneAttack", "Nuclear", "Shield2Gold", "HasNoZOC"
; No veteran levels (level name is never displayed)
veteran_names = _("green")
veteran_base_raise_chance = 0
veteran_work_raise_chance = 0
...
TIP 1: Nuking the ocean will not generate fallout, and is a most\
 ...
 ships.\
"), _("\
TIP 2: You may be involved in a situation where you have invaded an\
...
uk_food       = 0
uk_gold       = 0
flags         = "Diplomat", "IgZOC", "NonMil", "HasNoZOC", "Provoking"
veteran_names =
...
An explorer can be ordered to remain in a foreign city as an ambassador\
 ...
 owner, as well as intelligence on their national budget and technology.\
")

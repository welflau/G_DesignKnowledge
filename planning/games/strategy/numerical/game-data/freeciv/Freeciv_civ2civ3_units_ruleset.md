# Freeciv(civ2civ3) · units

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2civ3/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2civ3

## 概述
Freeciv civ2civ3规则集的units定义
...
[datafile]
description="Civ2Civ3 unit_type data for Freeciv21"
...
"), _("\
TIP: You may be involved in a situation where you've invaded an\
...
A Spy can also be used to:\n\n\
 - sabotage an enemy unit reducing its hitpoints to half, if it is\
 ...
 stolen from. Cities become more resistant each time they\
 are stolen from;\n\

# Freeciv(sandbox) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的buildings定义
...
[datafile]
description="Sandbox buildings data for Freeciv21"
...
A city with an Airport can airlift an extra unit per turn. Airlifting\
 ...
 points left to be airlifted, and cannot carry cargo.\
"), _("\
...
sound_alt	= "b_generic"
helptext	= _("\
Increases the luxury good and tax output in a city by an additional 50%. \
...
effects of a Factory or Mfg. Plant in its city by 25% each. \
...
happy in each of your cities (2 extra luxury goods per city). It further \
...
sound_alt	= "w_generic"
helptext	= _("\
Upgrades one obsolete unit per game turn for free.\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Gives 1 additional luxury good to every city, and 6 luxuries to the city \
where it is located.\
"), _("\

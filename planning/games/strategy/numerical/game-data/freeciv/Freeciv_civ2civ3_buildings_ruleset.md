# Freeciv(civ2civ3) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2civ3/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2civ3

## 概述
Freeciv civ2civ3规则集的buildings定义
...
[datafile]
description="Civ2Civ3 buildings data for Freeciv21"
...
for cities larger than size 8. They are ineffective against airborne and \
...
to be next to an ocean tile to build this improvement.\
"), _("\
...
of what it would otherwise be. A Courthouse will eliminate it \
entirely.\
"), _("\
...
25% in cities with another building which reduces pollution such as a \
...
and the Temple of Artemis wonder, 4 citizens are made content (3 under \
...
happy in each of your cities producing 2 extra luxury per city. It further \
...
producing 4 extra luxury good points.\
")
...
it, producing  2 extra luxury good points per city.\
")
...
"), _("\
TIP: if you are behind in research, this can help you catch up, by \
...
sound_alt	= "w_generic"
helptext	= _("\
Gives 1 additional luxury good point to every city, and 6 luxuries \
to the city where it is located.\
"), _("\
...
a row, that player's government falls to Anarchy, even for governments \

# Freeciv(sandbox) · cities

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/cities.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的cities定义
...
[datafile]
description="Sandbox cities data for Freeciv21"
...
helptext        = _("\
Each entertainer produces two luxury good points for their city per turn, \
increasing to three once any player has built Shakespeare's Theater. \
See the section on Happiness for the effects of luxury good points.\
")
...
helptext        = _("\
Each scientist adds two bulbs to your empire's research output \
...
helptext        = _("\
Each tax collector produces two extra gold for your national treasury \
...
changeable_budget = TRUE        ; set to FALSE to disallow changing of national budget
...
conquest_convert_pct = 25       ; percentage which converts to the new nation
...
food_unit_act     = "Explode Nuclear", "Help Wonder", "Join City",
                    "Establish Trade Route", "Enter Marketplace",
                    "Recycle Unit"
food_wipe         = TRUE

gold_protected    = "GameLoss"
gold_unit_act     = "Explode Nuclear", "Help Wonder", "Join City",
                    "Establish Trade Route", "Enter Marketplace",
                    "Recycle Unit"
gold_wipe         = TRUE

shield_protected  = "GameLoss"
shield_unit_act   = "Explode Nuclear", "Help Wonder", "Join City",
                    "Establish Trade Route", "Enter Marketplace",
                    "Recycle Unit"
shield_wipe       = TRUE

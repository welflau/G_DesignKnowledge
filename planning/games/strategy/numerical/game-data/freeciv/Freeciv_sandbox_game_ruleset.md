# Freeciv(sandbox) · game

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的game定义
...
[datafile]
description="Sandbox game rules for Freeciv21"
...
summary = _("\
You are playing Freeciv21 with sandbox ruleset. This showcases new or \
...
or savegame compatibility between versions. For more informatoin, see \
the detailed description (README.sandbox).\
")
...
[actionenabler_disrupt_supply_normal]
...
[actionenabler_disrupt_supply_marines]
action = "User Action 1"
actor_reqs    =
    { "type",         "name",          "range", "present"
      "UnitFlag",     "SupplyLines",   "Local", TRUE
...
[actionenabler_release_plague_from_bio_lab]
...
[actionenabler_paradrop_base_to_foreign_not_forest]
...
[actionenabler_paradrop_base_to_unclaimed_not_forest]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_veteran_base_to_foreign]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_veteran_base_to_unclaimed]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_city_to_foreign_not_forest]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_city_to_unclaimed_not_forest]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_veteran_city_to_foreign]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[actionenabler_paradrop_veteran_city_to_unclaimed]
action = "Paradrop Unit"
actor_reqs    =
    { "type",         "name",         "range", "present"
      "UnitFlag",     "Paratroopers", "Local", TRUE
...
[settings]
; Freeciv21 game settings for sandbox ruleset
;
set =
    { "name", "value"
      "aifill", 12

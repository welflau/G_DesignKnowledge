# Freeciv(civ2civ3) · game

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2civ3/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2civ3

## 概述
Freeciv civ2civ3规则集的game定义
...
[datafile]
description="Civ2Civ3 game rules for Freeciv21"
...
summary = _("\
You are playing Freeciv21 with civ2civ3 rules:\
\n\n\
Gameplay is more similar to civ3, keeping the combat system from civ2.\
\n\n\
Adapted for single player, with AI less aggressive at the start,\
 but more challenging at the end.\
\n\n\
The differences from the former default ruleset, 'classic', are listed in\
 full in the detailed description (README.civ2civ3).\
")
...
[settings]
; Freeciv21 game settings for civ2civ3 ruleset
;
set =
    { "name", "value"
      "aifill", 6

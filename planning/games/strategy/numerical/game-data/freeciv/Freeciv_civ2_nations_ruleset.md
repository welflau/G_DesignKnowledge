# Freeciv(civ2) · nations

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/nations.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的nations定义
...
[datafile]
description="Civ2-equivalent nations data for Freeciv21"
...
legend=_("The Carthaginians, descendants of Phoenician traders,\
 ...
 BC. Carthage was destroyed by Rome in 146 BC.")
...
ruler_titles = {
 ...
 "Fundamentalism",  _("Lord Protector %s"), _("Lady Protector %s")
}
...
leaders = {
 "name",                "sex"
 "Suiko",               "Female"
 "Tokugawa Ieyasu",     "Male"
}

ruler_titles = {
 "government",      "male_title",           "female_title"
 "Monarchy",        _("Emperor %s"),        _("Empress %s")
 "Republic",        _("Shogun %s"),         _("?female:Shogun %s")
 "Democracy",       _("Prime Minister %s"), _("?female:Prime Minister %s")
}
...
cities =
  ...
  "Sendai (ocean)",
  "Kawasaki (ocean)",
  "Kokura (ocean)",	; Modern-day "Kita-Kyushu"
  "Saitama (!ocean)",
  "Yokohama (ocean)",
  "Chiba (ocean)",
  "Shizuoka (ocean)",
  ...
  "Kushiro (ocean)",
  "Chofu (!ocean)",
  "Fuse (!ocean)",	; One of the old cities that now is "Higashi-Osaka"
  "Kumagaya (!ocean)",
  "Amagasaki (ocean)",
  "Ichikawa",
  "Saga",
...
groups="Ancient"
legend=_("The first Persian (Achaemenid) Empire lasted from 550 BC to 330\
 BC; the second (Sassanid) from 226 AD to 642 AD.")

leaders = {
 "name",                "sex"
 "Purandokht",          "Female"
 "Khshayarsha I",       "Male" ; a.k.a. "Xerxes"
}
...
cities =
; Ancient cities first; Latin rendering in comment
 "Parsa",	; Persepolis
 "Susa",
 "Hagmatana",	; Ecbatana
 "Pathragada",	; Pasaradae
 "Raga",	; Rhagae
 "Margush",	; Margiane
 "Baktra",
 "Takshasila",	; Taxila
...
legend=_("The modern Spanish nation was formed when the rulers of the\
 ...
 peninsula from the Moslems. The Reconquista was completed in 1492,\
 the same year Columbus sailed. Spain then went on to create an empire\
...
legend=_("The Vikings raided and traded along the coasts of Europe\
 between 800 AD and 1100 AD. Viking raiders eventually became the rulers\
...
; Freeciv21 should always pick the one "LandAndSea" barbarian in new games.
[nation_pirate]

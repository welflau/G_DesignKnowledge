# Freeciv(nation) · czechoslovak

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/nation/czechoslovak.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, nation

## 概述
Freeciv nation规则集的czechoslovak定义

## 正文
```ruleset
[nation_czechoslovak]

name = _("Czechoslovakian")
plural = _("?plural:Czechoslovakians")
groups="European"
...
leaders = {
 "name",                "sex"
 "Tomáš G. Masaryk",	"male"
 "Edvard Beneš",	"male"
 "Milada Horáková",	"female"
 "Klement Gottwald",	"male"
 "Antonín Novotný",	"male"
 "Alexander Dubček",	"male"
 "Jan Palach",		"male"
 "Gustáv Husák",	"male"
 "Vaclav Havel",	"male"
}

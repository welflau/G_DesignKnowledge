# Freeciv(multiplayer) · units

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/multiplayer/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, multiplayer

## 概述
Freeciv multiplayer规则集的units定义
...
uk_food       = 1
uk_gold       = 0
flags         = "Settlers", "Infra", "NonMil", "HasNoZOC", "AddToCity", "Cities", "Cant_Fortify"
...
"), _("\
Settlers can also perform most of the same terrain alterations as\
...
uk_food       = 0
uk_gold       = 0
flags         = "Settlers", "Infra", "NonMil", "HasNoZOC", "Airbase", "Cant_Fortify"
; No veteran levels (level name is never displayed)
veteran_names = _("green")
veteran_base_raise_chance = 0
veteran_work_raise_chance = 0
...
uk_food       = 0
uk_gold       = 0
flags         = "Settlers", "Infra", "NonMil", "HasNoZOC", "Transform", "Airbase", "Cant_Fortify"
; No veteran levels (level name is never displayed)
veteran_names = _("green")
veteran_base_raise_chance = 0
veteran_work_raise_chance = 0
...
Crusaders are highly disciplined mounted\
 warriors driven by a higher, often religious, cause.\
")
...
The Helicopter is a very powerful unit, as it can both fly and\
 ...
 or on a Carrier, and they may be attacked by ground units.\
")
...
flags         = "BadCityDefender", "Only_Native_Attack", "Provoking"
roles         = ""
helptext      = _("\
...
uk_food       = 0
uk_gold       = 0
flags         = "HelpWonder", "IgZOC", "NonMil", "HasNoZOC"
roles         = ""
helptext      = _("\

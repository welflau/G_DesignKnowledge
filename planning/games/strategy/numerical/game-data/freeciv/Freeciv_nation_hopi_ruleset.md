...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/nation/hopi.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, nation

## 概述
Freeciv nation规则集的hopi定义
...
name=_("Hopi")
plural=_("?plural:Hopis")
groups="American"

legend=_("A matrilineal culture in North America, who claim descent from the\
...
civilwar_nations = "raramuri", "sioux"

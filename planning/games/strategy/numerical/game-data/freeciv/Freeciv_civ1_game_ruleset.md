...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ1/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ1

## 概述
Freeciv civ1规则集的game定义
...
[datafile]
description="Civ1-style game rules for Freeciv21"
...
summary = _("\
You are playing with civ1 style rules. \
These rules are much simpler than the Freeciv21 default rules. \
...
;
; TODO: What`s correct "bonus" behavior for civ1? I don`t remember it having one-time
;       bonuses at all, but they have always been present in Freeciv21.
;
[trade]
settings =
...
[settings]
; Freeciv21 game  for the civ1 ruleset
;
; set =
;     { "name", "value", "lock"
;       "bool_set", TRUE, FALSE

# Freeciv(classic) · units

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/classic/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, classic

## 概述
Freeciv classic规则集的units定义
...
[datafile]
description="Classic unit_type data for Freeciv21"
...
uk_food       = 0
uk_gold       = 0
flags         = "Settlers", "Cant_Fortify", "NonMil", "HasNoZOC", "Transform", "Airbase"
; No veteran levels (level name is never displayed)
veteran_names = _("green")
veteran_base_raise_chance = 0
veteran_work_raise_chance = 0
...
An improved Fighter, with improved attack and a higher movement\
 radius. Stealth Fighters have a disadvantage against Helicopters.\
")

...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/techs.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的techs定义
...
[datafile]
description="Civ2 technology data for Freeciv21 (incomplete)"
...
graphic_alt = "-"
helptext = _("Allows Settlers and Engineers to build fortresses.")
...
graphic_alt = "-"
helptext = _("\
* Reduces the odds of triremes sinking away from shore to 1/4.\
")
...
graphic     = "a.radio"
graphic_alt = "-"
helptext = _("Allows Settlers and Engineers to build airbases.")
...
graphic_alt = "-"
helptext = _("\
* Reduces the odds of triremes sinking away from shore to 1/3.\
")

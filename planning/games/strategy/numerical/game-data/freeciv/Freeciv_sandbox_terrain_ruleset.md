# Freeciv(sandbox) · terrain

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/terrain.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的terrain定义
...
[datafile]
description="Sandbox terrain data for Freeciv21"
...
cooler_drier_result  = "no"
native_to            = "Land", "Small Land", "Big Land", "Air", "Missile", "Helicopter"
flags                = "Starter", "CanHaveRiver", "DifficultLanding"
property_cold        = 20
property_wet         = 20
property_foliage     = 50
...
flags                = "CanHaveRiver", "DifficultLanding"
property_foliage     = 50
property_tropical    = 50
property_wet         = 50
color.r              = 55
...
"), _("\
Building irrigation on a tile with a mine or oil well will destroy the mine or oil well.\
"), _("\
...
appearance_reqs  =
    { "type", "name", "range", "present", "quiet"
      ...
      "MinYear", "1000", "World", FALSE, FALSE
      "CityTile", "Center", "Local", FALSE, TRUE
      "Extra", "Hut", "Local", FALSE, FALSE
    }
appearance_chance = 1
helptext = _("\
One can explore Hermit's Places once the philosopher has abandoned them. In most \
cases one can learn some of the wisdom of the former inhabitant, with the cost \
of 20% of the normal price. \
After year 1000 there is no more such individuals figuring entire technologies \
out in the solitude. \
")

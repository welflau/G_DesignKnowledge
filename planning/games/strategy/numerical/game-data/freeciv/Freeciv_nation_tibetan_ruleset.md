# Freeciv(nation) · tibetan

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/nation/tibetan.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, nation

## 概述
Freeciv nation规则集的tibetan定义
...
leaders = {
 "name",                "sex"
 "Songtsen Gampo",      "Male" ; 7th century king
 "Trisonog Detsen",     "Male" ; 8th century king
 "Tri Ralpachen",       "Male" ; 9th century king
 "Changchub Gyaltsen",  "Male" ; 14th century king
 "Lozang Gyatso",       "Male" ; 5th Dalai Lama (1617-1682)
 "Thupten Gyatso",      "Male" ; 13th Dalai Lama (1876-1933)
}

ruler_titles = {
 "government",     "male_title",           "female_title"
 "Fundamentalism", _("Dalai Lama %s"),     _("?female:Dalai Lama %s")
}
...
init_buildings=""
init_units=""
civilwar_nations = "mongol", "nepali", "bhutanese", "sherpa"

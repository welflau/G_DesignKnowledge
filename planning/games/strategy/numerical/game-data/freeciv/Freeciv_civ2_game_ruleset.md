...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的game定义
...
[datafile]
description="Civ2-style game rules for Freeciv21"
...
summary = _("\
You are playing with civ2 style rules. These are\
 quite close to classic (default) Freeciv21 rules,\
...
; No achievements in civ2 ruleset
...
;
; TODO: What`s correct "cancelling" behavior for civ2? If you have established
...
;
; TODO: What`s correct "bonus" behavior for civ2?
;
[trade]
settings =
...
[settings]
; Freeciv21 game settings for the civ2 ruleset
;
; set =
;     { "name", "value", "lock"
;       "bool_set", TRUE, FALSE

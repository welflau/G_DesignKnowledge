# Freeciv(classic) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/classic/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, classic

## 概述
Freeciv classic规则集的buildings定义
...
[datafile]
description="Classic buildings data for Freeciv21"
...
; but the above describes current Freeciv21 rules.
...
; describes current Freeciv21 rules.
...
Together with a Marketplace and a Bank, a Stock Exchange boosts\
 tax and luxury good production in a city by 150%.\
")
...
The civilization which builds the Great Library gets every advance\
 that at least two other players or teams have achieved.\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Works as a City Wall in all of your cities.\
")
; NOTE:

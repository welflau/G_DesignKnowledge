# Freeciv(sandbox) · units

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的units定义
...
[datafile]
description="Sandbox Units data for Freeciv21"
...
flags =
  { "name", "helptxt"
    ...
    _("SupplyLines"), _("Can slow down (take 1 MP from) an enemy unit by disrupting its supply lines.")
...
veteran_base_raise_chance = 33, 22, 13, 0
...
uk_food       = 1
uk_gold       = 0
flags         = "Settlers", "Cant_Fortify", "NonMil", "HasNoZOC", "AddToCity", "Cities"
...
flags         = "IgTer", "Capturer", "SupplyLines"
...
embarks       = "Helicopter"
disembarks    = "Helicopter"
flags         = "IgTer", "IgZOC", "Capturer", "SupplyLines"
...
embarks       = "Helicopter"
disembarks    = "Helicopter"
flags         = "Fanatic", "AddToCity", "Capturer", "SupplyLines"
...
embarks       = "Helicopter"
disembarks    = "Helicopter"
flags         = "Marines", "Capturer", "SupplyLines"
...
embarks       = "Helicopter"
disembarks    = "Helicopter"
flags         = "Paratroopers", "Capturer", "SupplyLines"
roles         = "DefendOk", "DefendOkStartUnit"
helptext      = _("\
...
The Caravel is a sailing ship that can enter\
 any ocean tile, but have to spend at least every third\
 turn change next to land to load supplies for the crew.\
")
...
The AEGIS Cruiser is equipped with an advanced\
 ...
 disvantage against AEGIS Cruisers.\
")
...
You can build Nuclear units when you have the required advance, and\
 the Manhattan Project wonder has been built by any player.\
"), _("\
Has unlimited range but 0 moves. Specify the target tile by selecting\
 the ICBM, ordering `Do...` (or by pressing `d`) and then clicking at the\
 target tile.\
"), _("\
On impact, the blast will destroy any unit in an area 3 tiles wide\
 (3x3 squares for rectangular grids), including friendly units.\
...
Nuclear fallout reduces tile output and increases the risk of global\
 nuclear winter. See the help on Fallout.\
"), _("\
Make sure that the upkeep (gold and shield) of your ICBM is payed.\
 A non maintained nuke will detonate in place.\
"), _("\
TIP: You may be involved in a situation where you have invaded an\
 enemy country en masse, but the enemy cities are too strong.\
 Before using a Nuclear unit, assemble a gang of cleanup units\
...
"), _("\
 ...
 on their national budget and technology. Each player you have an embassy\
...
A Spy can also be used to:\n\n\
 ...
 success);\n\
 - release plague in an enemy city if it has a Research Lab\
 and the Spy's owner knows Medicine.\
 Be careful! Plague spreads along trade routes.\
"), _("\
...
uk_food       = 0
uk_gold       = 1
flags         = "IgTer", "IgZOC", "NonMil", "HasNoZOC"
...
Explorers can also perform some actions in another player's city,\
 and like Diplomats and Spies, the unit is not consumed by these\
 harmless actions:\
"), _("\
 - \"Establish Embassy\": This action always succeeds, and gives\
 permanent contact with the city's owner, as well as intelligence\

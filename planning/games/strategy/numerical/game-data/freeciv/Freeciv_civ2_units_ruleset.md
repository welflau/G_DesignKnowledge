...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的units定义
...
[datafile]
description="Civ2 unit_type data for Freeciv21 (approximate)"
...
uk_food       = 1
uk_gold       = 0
flags         = "Settlers", "Cant_Fortify", "NonMil", "Airbase", "AddToCity", "Cities", "NoVeteran"
...
uk_food       = 1
uk_gold       = 0
flags         = "Settlers", "Cant_Fortify", "NonMil", "Transform", "Airbase", "AddToCity", "Cities", "NoVeteran"
roles         = "Settlers", "WorkerStartUnit", "CitiesStartUnit"
helptext      = _("\
...
uk_gold       = 0
cargo         = "Land"
flags         = "Coast", "BadCityDefender", "Provoking"
...
The Trireme is your first boat unit. It can act\
 ...
 capabilities. If it ends its turn away from shore, it has a 1/2\
 chance of sinking. This is reduced to 1/3 after Seafaring, 1/4\
 after Navigation, and eliminated by the Lighthouse wonder.\
")
...
uk_food       = 0
uk_gold       = 0
flags         = "Diplomat", "IgZOC", "NonMil", "Spy", "Provoking"
veteran_names = _("green"), _("veteran")
veteran_base_raise_chance = 50, 0
veteran_work_raise_chance = 0, 0
veteran_power_fact = 100, 110

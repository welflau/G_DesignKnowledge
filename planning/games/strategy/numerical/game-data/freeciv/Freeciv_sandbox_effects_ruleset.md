# Freeciv(sandbox) · effects

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/sandbox/effects.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, sandbox

## 概述
Freeciv sandbox规则集的effects定义
...
[datafile]
description="Sandbox effects data for Freeciv21"
...
; Corruption + waste = 30% for all govs
...
reqs    =
    { "type", "name", "range", "present", "quiet"
      "Gov", "Despotism", "Player", TRUE, TRUE
      "Building", "Ecclesiastical Palace", "City", TRUE, FALSE
...
[effect_incident_success_spy_attack]
type	= "Casus_Belli_Success"
value	= 1
reqs	=
    { "type", "name", "range", "present"
      "Action", "Spy Attack", "Local", TRUE
      "DiplRel", "War", "Local", FALSE
    }
...
; A successful release endangers every player connected by trade routes.
; Who cares that it was done during war against someone else?
[effect_release_plague_incident_success]
type	= "Casus_Belli_Success"
value	= 1000
reqs	=
    { "type",    "name",          "range", "present"
      "Action",  "Spread Plague", "Local", TRUE
    }

; An attempted release can be brushed under the rug internationally.
[effect_release_plague_incident_caught]
type	= "Casus_Belli_Caught"
value	= 1
reqs	=
    { "type",    "name",          "range", "present"
...
[effect_incident_success_pillage]
type	= "Casus_Belli_Success"
value	= 1
reqs	=
    { "type", "name", "range", "present"
      "Action", "Pillage", "Local", TRUE
      "DiplRel", "War", "Local", FALSE
    }
...
[effect_action_success_move_cost_disrupt]
type    = "Action_Success_Actor_Move_Cost"
value   = 1
reqs    =
    { "type", "name", "range", "present"
...
[effect_action_success_move_cost_disrupted]
type    = "Action_Success_Target_Move_Cost"
value   = 6
reqs    =
    { "type", "name", "range", "present"

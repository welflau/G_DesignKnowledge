# Freeciv(royale) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/royale/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, royale

## 概述
Freeciv royale规则集的buildings定义
...
[datafile]
description="Royale buildings data for Freeciv21"
...
"), _("\
A city with Airport can airlift one unit per turn (including\
 ...
 carry cargo. The current setting (unlimited to destination) means that\
 the destination city does not need to have an airport.\
")
...
"), _("\
Starting at size 5, growing cities incur an increasing risk of plague \
due to overcrowding. An Aqueduct, Lake reduces that base chance by 30%.\
"), _("\
...
"), _("\
Starting at size 5, growing cities incur an increasing risk of plague \
due to overcrowding. An Aqueduct, River reduces that base chance by 30%.\
"), _("\
...
helptext	= _("\
Increases the luxury good and tax output in a city by an additional 30%. \
With both a Bank and a Marketplace in a city, the total bonus is 80%.\
")

[building_mercantile_exchange]
name		= _("Mercantile Exchange")
genus		= "Improvement"
reqs	=
    { "type", "name", "range"
...
helptext	= _("\
Increases the luxury good and tax output in a city by an additional 30%. \
With a Mercantile Exchange, a Bank and a Marketplace in a city, the total bonus is 110%.\
")
...
; /* xgettext:no-c-format */
helptext	= _("\
With a Barracks, each new land unit built in a city (except siege units like Catapults)\
 will automatically have Veteran status, which means that its attack and\
...
; /* xgettext:no-c-format */
helptext	= _("\
With a Barracks II, each new land unit built in a city\
 (except siege units like Cannon and Artillery) will\
...
; /* xgettext:no-c-format */
helptext	= _("\
With a Barracks III, each new land unit built in a city\
 (except siege units like Artillery and Howitzer) will\
 automatically have Veteran status, which means that its attack and\
 defense strengths are increased by 50%.\
"), _("\
Also, damaged land units which stay in town for one full turn\
...
; /* xgettext:no-c-format */
helptext	= _("\
Increases the shield production in a city by 50%, or 100% with an \
...
sound_alt	= "b_generic"
helptext	= _("\
When any small city grows or shrinks, 50 % of food points are saved. This \
helps cities to grow faster and more easily withstand famine. With a \
Granary this is extended to cities of size 4 and above. \
"), _("\
...
effects of a Factory or Mfg. Plant in its city by 50% each. \
Thus, an electrical plant in combination with either a Factory \
or Mfg. Plant gives a 100% production bonus over \
the level without any of these improvements. An electrical plant, \
Factory, and Mfg. Plant together give a 200% production bonus. \
...
; /* xgettext:no-c-format */
helptext	= _("\
Increases the luxury good and tax output in a city by 50%.\
")
...
two other buildings. It also increases the working area for the city.\
")
...
; /* xgettext:no-c-format */
helptext	= _("\
Increases the shield production in a city by an additional 50%, or \
100% with an electrical plant of any kind in the same city. This \
...
sound_alt	= "b_generic"
helptext	= _("\
Makes a city the 2nd capital, that acts as a second center \
of government.\
"), _("\
Waste in other cities (corruption, production waste, and food waste) \
...
entirely).\
"), _("\
The city where this second palace is located cannot be incited to revolt, \
...
[building_sdi_defense_1]
name		= _("SDI Defense I")
genus		= "Improvement"
reqs	=
    { "type", "name", "range"
      "Tech", "Radio", "Player"
    }
graphic	= "b.sdi_defense_1"
graphic_alt	= "b.sdi_defense"
obsolete_by	=
    { "type", "name", "range"
    }
build_cost	= 60
...
deliberately exploded) within range, may be shot down and simply has no effect. \
Also, adds 30% to the intrinsic defense strength of units in the city when \
defending against conventional missiles. SDI I + capital protects against 100% of the nuclear attacks while \
SDI I only defends against 30% of the attacks. SDI I + Palace adds 100% to the defense against missiles.\
 NOTE: The Palace City gets 100% SDI defense with the Palace and with SDI I. SDI II and SDI III are not needed.\
")

[building_sdi_defense_2]
name		= _("SDI Defense II")
genus		= "Improvement"
reqs	=
    { "type", "name", "range"
      "Tech", "Laser", "Player"
...
deliberately exploded) within range, may be shot down and simply has no effect. \
Also, adds 30% to the intrinsic defense strength of units in the city when \
defending against conventional missiles. SDI II adds another 30% against the nuclear attacks.\
 NOTE: The Palace City gets 100% SDI defense with the Palace and with SDI I. SDI II and SDI III are not needed.\
 The Palace with SDI II but without SDI I doesn't give 100% defense against nukes.\
")

[building_sdi_defense_3]
name		= _("SDI Defense III")
genus		= "Improvement"
reqs	=
    { "type", "name", "range"
      "Tech", "Space Flight", "Player"
	  "Building", "SDI Defense II", "City"
    }
graphic	= "b.sdi_defense_3"
graphic_alt	= "b.sdi_defense"
obsolete_by	=
    { "type", "name", "range"
    }
...
teammate which attacks a city with SDI Defense, or attacks a unit (or is \
deliberately exploded) within range, may be shot down and simply has no effect. \
Also, adds 40% to the intrinsic defense strength of units in the city when \
defending against conventional missiles. SDI III adds another 30% against the nuclear attacks.\
 NOTE: The Palace City gets 100% SDI defense with the Palace and with SDI I. SDI II and SDI III are not needed.\
 The Palace with SDI III but without SDI I doesn't give 100% defense against nukes.\
")
...
Before you can build any spaceship parts, the Apollo Program wonder\
 must have been built by any player. The city must also have a Factory,\
 Library, University, and a Research Lab.\
")
...
Space Structurals form the base of your spaceship. All other\
 spaceship parts need to be connected to Space Structurals in order to\
...
; /* xgettext:no-c-format */
helptext	= _("\
Increases the luxury good and tax output in a city by an additional 40%, \
or 65% if Super Highways are also in the city. A Marketplace, Bank, \
Mercantile Exchange, and Stock Exchange together in a city yield a total bonus of 150%. \
Adding Super Highways yields a total of 175%.\
")
...
sound_alt	= "b_generic"
helptext	= _("\
Each tile around the city with roads and without farmland, that\
 is already generating some trade, produces one extra trade resource.\
 The same applies to the city center tile (even if it is receiving a\
 farmland bonus).\
"), _("\
Also doubles the effect of any Stock Exchange in the city (increasing\
 luxury good and tax output by an additional 50%).\
"), _("\
...
reduces your risk of plague (by 10% of the base chance). With \
knowledge of Medicine, any of your cities with an Aqueduct and a \
Sewer System will be entirely free of plague.\
")
...
and thereafter 10 extra research points every turn to its city.\
"), _("\
Completion of this wonder permanently adds 50% to the effect of Libraries \
for every player.\
")
...
; /* xgettext:no-c-format */
helptext	= _("\
Increases the defense of all your cities by adding a +40% bonus to \
...
helptext	= _("\
Gives an immediate technology advance to the player that builds it, \
and thereafter 12 extra research points every turn to its city.\
"), _("\
Completion of this wonder permanently adds 50% to the effect of \
...
it (2 extra luxury good points per city).\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Upgrades two obsolete units per game turn for free.\
")

[building_verrocchio_workshop]
name		= _("Verrocchio's Workshop")
genus		= "GreatWonder"
reqs	=
    { "type", "name", "range"
      "Tech", "Invention", "Player"
    }
graphic	= "b.verrocchios_workshop"
graphic_alt	= "b.leonardos_workshop"
obsolete_by	=
    { "type", "name", "range", "survives"
...
sound_alt	= "w_generic"
helptext	= _("\
Upgrades one obsolete unit per game turn for free. The workshop where \
Leonardo da Vinci was a garzone (studio boy) before he was able to set up his own workshop.\
")
...
helptext	= _("\
The Manhattan Project will make it possible to build nuclear weapons. After it is built, \
anyone with the necessary technological advances can build nuclear weapons. The Nuclear \
Fission advance is required to build the early Nuclear Bomb, which is unique to a nation: \
each nation can have only one at a time. The Robotics advance is required to build the \
later Nuclear units, which are not limited in number.\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Increases trade output by 30% in all cities for all the\
 players. The player owning this wonder is the only one able to build the Trade Company. \
"), _("\
TIP: it may make sense to let someone else to build this wonder. Everyone gets the effect \
and the Trade Conpany can't usually be instantly built after Marco Polo is finished.\
")

[building_trade_company]
name		= _("Trade Company")
genus		= "GreatWonder"
reqs	=
    { "type", "name", "range"
      "Tech", "Navigation", "Player"
...
sound_alt	= "w_generic"
helptext	= _("\
This wonder gives the player extra trade with \
far away countries. Increases trade output by 10% in \
all cities owned by the player.\
")

[building_atlantic_telegraph_company]
name		= _("Atlantic Telegraph Company")
genus		= "GreatWonder"
reqs	=
    { "type", "name", "range"
...
graphic	= "b.atlantic_telegraph_company"
...
sound_alt	= "w_generic"
helptext	= _("\
The world will become smaller place with when the new means \
of communication connect all the people over the globe. \
All the players will get an embassy with all the players. \
The city where the wonder is located gets extra trade for each \
tile already producing trade.\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Reduces by 1 the unhappiness caused by one aggressively deployed \
military unit per city -- in other words, in each city it neutralizes \
the unhappiness caused by a single military unit (except under \
Democracy, where it just halves the unhappiness from that unit). \
Each city also avoids one shield of upkeep for units.\
")
...
where it is located.\
"), _("\
Upon completion of this wonder, entertainer specialists' luxury good \
...
[building_hal_salflieni_hypogeum]
name		= _("Hal Saflieni Hypogeum")
genus		= "SmallWonder"
reqs	=
    { "type", "name", "range"
      "Tech", "Ceremonial Burial", "Player"
...
sound_alt	= "w_generic"
helptext	= _("\
Ħal Saflieni Hypogeum is thought to have been a sanctuary and necropolis. \
It pre-dates the Bronze Age and was one of the first, if not the first, shrines built. \
With this wonder, the city having it will get +6 additional luxury good points. The effect \
of this very early wonder ends with the invention of bronze working. \
")
...
This is not a normal improvement. Instead, setting a city's\
 ...
 converted to tax output (money, gold!).\
")
...
been researched by your civilization. It also allows unprovoked declaration of war \

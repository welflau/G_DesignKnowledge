# Freeciv(civ2) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ2/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ2

## 概述
Freeciv civ2规则集的buildings定义
...
[datafile]
description="Civ2 buildings data for Freeciv21 (incomplete)"
...
Allows a city to produce veteran air units (including helicopters) and\
 missiles. \
Also, damaged air units (including helicopters) which stay in\
...
content (four after the discovery of Electronics). However, it \
...
; /* xgettext:no-c-format */
helptext	= _("\
Together with a Library and a Research Lab increases the science\
...
obsolete_by	=
    { "type", "name", "range", "survives"
      "Tech", "Industrialization", "World", TRUE
    }
build_cost	= 300
upkeep		= 0
sabotage	= 0
...
Gives all your sea units 1 additional movement point. Makes all your\
 new military sea units veterans (for all cities). Triremes no\
 longer get lost away from shore.\
")
...
All your new military land units become veterans (for all cities).\
 The chance of a land unit becoming a veteran after a battle increases\
 from 50% to 100%.\
")
...
sound_alt	= "w_generic"
helptext	= _("\
Counts as a Police Station in every city. This means, for each city, it\
 reduces the unhappiness caused by aggressively deployed military\

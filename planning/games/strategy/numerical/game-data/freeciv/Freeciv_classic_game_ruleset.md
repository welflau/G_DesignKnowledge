# Freeciv(classic) · game

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/classic/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, classic

## 概述
Freeciv classic规则集的game定义
...
[datafile]
description="Classic game rules for Freeciv21"
...
summary = _("\
You are playing with the classic Freeciv21 ruleset for single player games. \
Note that in addition to the ruleset, also server settings affect \
the rules of the game. For more information refer to the detailed description \
(README.classic).\
")
...
[settings]
; Freeciv21 game settings for the classic ruleset
;
; set =
;     { "name", "value", "lock"
;       "bool_set", TRUE, FALSE

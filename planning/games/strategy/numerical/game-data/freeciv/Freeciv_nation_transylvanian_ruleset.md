# Freeciv(nation) · transylvanian

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/nation/transylvanian.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, nation

## 概述
Freeciv nation规则集的transylvanian定义

## 正文
```ruleset
[nation_transylvanian]

name=_("Transylvanian")
plural=_("?plural:Transylvanians")
groups="Early Modern", "European"
legend=_("Transylvania is a historical territory in what is now Romania,\
 inhabited by Romanians, Hungarians and Saxon Germans. Transylvania became\
 a principality under nominal Hungarian suzereignty when that country\
...
leaders = {
 "name",                "sex"
 "János Szapolyai",     "Male"
 "Hunyadi János",       "Male"
 "Bethlen Gábor",       "Male"
 "Rákóczi György",      "Male"
 "Báthory Erzsébet",    "Female"
 "Rákóczi Ferenc",      "Male"
 "Bem József",          "Male"
}
...
civilwar_nations = "romanian", "hungarian", "vampire"

# Freeciv(multiplayer) · effects

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/multiplayer/effects.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, multiplayer

## 概述
Freeciv multiplayer规则集的effects定义
...
[datafile]
description="Multiplayer effects data for Freeciv21"
...
reqs	=
    { "type", "name", "range", "present"
      ...
      "Building", "Michelangelo's Chapel", "Continent", FALSE
    }
...
reqs	=
    { "type", "name", "range", "present"
      ...
      "UnitClass", "Land", "Local", TRUE
      "Building", "Great Wall", "Continent", FALSE
...
reqs	=
    { "type", "name", "range"
      "Building", "Amphitheatre", "City"
    }

[effect_amphitheatre_1]
type    = "Make_Content"
value	= 1
reqs	=
    { "type", "name", "range"
...
reqs	=
    { "type", "name", "range", "present"
      ...
      "OutputType", "Shield", "Local", TRUE
      "Building", "Hoover Dam", "Continent", FALSE
...
reqs	=
    { "type", "name", "range", "present"
      ...
      "Building", "Women's Suffrage", "Continent", FALSE
    }
...
reqs	=
    { "type", "name", "range", "survives"
      "Building", "Apollo Program", "Player", TRUE
    }
...
reqs	=
    { "type", "name", "range"
      "Building", "A.Smith's Trading Co.", "Continent"
    }
...
value	= 2
 reqs	=
     { "type", "name", "range"
      "Building", "Cure For Cancer", "World"
      "Tech", "Genetic Engineering", "Player"
     }

; /* <-- avoid gettext warnings
; HACK: these effects, with no net outcome, are here only to prevent
; is_building_replaced() in common/effects.c from returning TRUE for
; Darwin's Voyage (and consequently having the city production list
; draw it with strike-through).
; The actual giving of 2 techs is done in the lua script, so that players
; cannot get the bonus again when rebuilding the small wonder.
; */ <-- avoid gettext warnings
...
value	= 1
 reqs	=
    { "type", "name", "range"
      "Building", "Eiffel Tower", "Continent"
      "OutputType", "Shield", "Local"
    }
...
value	= 50
 reqs	=
    { "type", "name", "range"
      "Building", "Great Library", "Continent"
      "OutputType", "Trade", "Local"
    }
...
reqs	=
    { "type", "name", "range", "present"
      "Building", "Great Wall", "Continent", TRUE
      "UnitClass", "Land", "Local", TRUE
      "CityTile", "Center", "Local", TRUE
      "UnitType", "Howitzer", "Local", FALSE
    }
...
reqs	=
    { "type", "name", "range"
      "Building", "University", "City"
      "Building", "Isaac Newton's College", "Continent"
      "OutputType", "Science", "Local"
    }
...
reqs	=
    { "type", "name", "range"
      "Building", "Magellan's Expedition", "Continent"
      "UnitClass", "Sea", "Local"
    }

; Should be quite useless, just in case:
[effect_magellans_expedition_1]
type    = "Veteran_Build"
value	= 1
reqs	=
    { "type", "name", "range"
...
reqs	=
    { "type", "name", "range"
      "Building", "Marco Polo's Embassy", "Continent"
      "OutputType", "Trade", "Local"
    }
...
reqs	=
    { "type", "name", "range"
      "Building", "Michelangelo's Chapel", "Continent"
    }
...
reqs	=
    { "type", "name", "range"
      "Building", "Research Lab", "City"
      "Building", "The Internet", "Continent"
      "OutputType", "Science", "Local"
    }
...
; Without !present UN would make revolution less likely instead
; of enabling it with Democracy (value 2 -> 4 instead of 0 -> 2)
...
reqs	=
    { "type", "name", "range"
      "Gov", "Republic", "Player"
      "Building", "Women's Suffrage", "Continent"
    }
...
[effect_corruption_fundamentalism0]
type    = "Output_Waste"
value   = 2
reqs    =
    { "type", "name", "range"
...
[effect_corruption_fundamentalism1]
type    = "Output_Waste_By_Distance"
value   = 200
reqs    =
    { "type", "name", "range"
...
reqs	=
    { "type", "name", "range", "present"
      ...
      "Action", "Transport Alight", "Local", FALSE
...
; Double (+100%) buy cost for Small Wonders except Palace

# Freeciv(experimental) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/experimental/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, experimental

## 概述
Freeciv experimental规则集的buildings定义
...
[datafile]
description="Experimental buildings data for Freeciv21"
...
Together with the Marketplace improvement, a Bank increases the\
 luxury good and tax production within a city by 100%.\
")
...
Increases the effect of a Factory and Mfg. Plant on the shield\
 production of a city, and also reduces the amount of pollution\
 generated by that production.   Nuclear Plant in combination with\
 either a Factory or Mfg. Plant gives a 75% production bonus over\
 the level without any of these improvements, while giving pollution\
 only 75% of the equivalent combination with a Power Plant. A\

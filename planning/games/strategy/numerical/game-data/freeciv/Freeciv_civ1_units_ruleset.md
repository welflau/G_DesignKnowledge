...
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ1/units.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ1

## 概述
Freeciv civ1规则集的units定义
...
[datafile]
description="Civ1-style unit_type data for Freeciv21"
...
uk_food       = 1
uk_gold       = 0
flags         = "Settlers", "Cant_Fortify", "NonMil", "AddToCity", "Cities", "NoVeteran"
...
helptext      = _("\
Mechanized Infantry has the strongest defense strength\

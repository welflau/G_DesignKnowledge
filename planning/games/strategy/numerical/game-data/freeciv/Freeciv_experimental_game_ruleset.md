# Freeciv(experimental) · game

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/experimental/game.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, experimental

## 概述
Freeciv experimental规则集的game定义
...
[datafile]
description="Experimental game rules for Freeciv21"
...
description_file = "experimental/README.experimental"
...
;
; This ruleset will be renamed as "goldkeep" in a future version.
; Set information of the future name so that once someone tries to load
; savegame saved with this version to that future version, ruleset is
; found from the directory it`s in.
alt_dir = "goldkeep"

; Summary of the ruleset
; /* TRANS: In the client, this is displayed alongside the contents of
;    README.experimental, which are not localized. */
summary = _("\
You are playing with the experimental ruleset. This showcases new or \
unusual features available in Freeciv21 without regard for strict game \
balancing or playability. A detailed description of the differences from the \
classic ruleset can be found in README.experimental.\
")
...
initial_diplomatic_state = "Cease-fire"
...
[settings]
; Freeciv21 game settings for the experimental ruleset
;
; set =
;     { "name", "value", "lock"
;       "bool_set", TRUE, FALSE

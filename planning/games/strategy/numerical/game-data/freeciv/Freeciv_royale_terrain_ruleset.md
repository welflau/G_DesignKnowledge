# Freeciv(royale) · terrain

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/royale/terrain.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, royale

## 概述
Freeciv royale规则集的terrain定义
...
[datafile]
description="Royale tile_type data for Freeciv21"
...
native_to            = "Sea", "Air", "Missile", "Helicopter", "Trireme"
flags                = "NoCities", "UnsafeCoast", "NoZoc", "NoFortify", "Sea", "NoPollution"
...
cooler_wetter_result = "no"
cooler_drier_result  = "no"
native_to            = "Land", "Small Land", "Merchant", "Big Land", "Air", "Missile", "Helicopter", "Big Siege"
flags                = "NoBarbs", "CanHaveRiver", "Oil", "Frozen"
property_frozen      = 100
color.r              = 232
color.g              = 232
color.b              = 232
...
"), _("\
Deserts can be irrigated for a small amount of extra food, but without\
 an oasis or river, bare desert cannot be further improved with\
 farmland.\
"), _("\
...
Cities built in hills are at risk of earthquakes, which can interrupt\
 a city's current production project.\
")
...
cooler_drier_result  = "Tundra"
native_to            = "Land", "Small Land", "Merchant", "Air", "Missile", "Helicopter"
flags                = "CanHaveRiver"
property_foliage     = 50
property_tropical    = 50
property_wet         = 50
...
Jungles are densely overgrown, making agriculture somewhat\
 problematic. Some land units may not move into jungle without\
 a road.\
")
...
Land units that move into mountains can see an extra space, but a\
 ...
 its next turn with one fewer movement point. Some land units may not\
...
Swamps suffer from an over-abundance of water, making agriculture\
 somewhat problematic. Some land units may not move in swamps without\
 a road.\
")
...
ui_name_base_fortress = _("?gui_type:Build Pre-Fortress/Fortress/Buoy")
...
of water: an ocean, lake, or river tile, or another tile with an \
...
water source is removed. Once Electricity is known, any suitable \
tile may be irrigated without a water source.\
"), _("\
Building irrigation on a tile with a mine or oil well will destroy the \
mine or oil well.\
"), _("\
...
number of production points produced by that tile. Hills and Mountains \
get an extra 2 production points per tile. Other terrains get 1 extra \
production point.\
"), _("\
...
has a Supermarket, a farmland tile provides 50% more food. (Hence, \
farmland is only useful on tiles which with irrigation yield 2 or more \
food.)\
"), _("\
NOTE: Farmland on a tile prevents any trade bonus from Super Highways.\
"), _("\
...
; /* xgettext:no-c-format */
helptext       = _("\
A Pre-Fortress is the groundwork for a Fortress, and in itself does nothing but \
allow further expansion to a Fortress.\
")
...
reqs           =
    { "type", "name", "range", "present", "quiet"
      "Extra", "Pre-Fortress", "Local", TRUE, FALSE
      "Tech", "Construction", "Player", TRUE, FALSE
      "TerrainClass", "Land", "Local", TRUE, FALSE
      "UnitFlag", "Settlers", "Local", TRUE, FALSE
      "UnitClass", "Sea", "Local", FALSE, TRUE
...
build_time     = 3
removal_time   = 0
native_to      = "Land", "Small Land", "Merchant", "Big Land", "Big Siege"
conflicts      = "Airbase"
...
"), _("\
Units in a fortress receive extra defense (+100%) \
against land units and boats, and do not count as aggressive if near a friendly city. \
...
conflicts      = "Pre-Fortress", "Fortress"
flags          = "Refuel", "ParadropFrom"
helptext       = _("\
An Airbase provides permanent support for air units and missiles. Air units can land \
and refuel on an Airbase and Paratroopers can be sent from Airbases. \
"), _("\
Units in Airbases do not count as aggressive if near a friendly city, and can \
see further afield. Also, air units recover more hit points (a third per \
turn, the same as in a city without an Airport).\
"),
_("Airbases have efficient anti-air weapons: units in an Airbase receive extra defense (+100%) \
against air units and missiles. ")
...
They have no effect on gameplay other than giving +1 trade bonus for the tile with the ruins.\
")
...
build_time     = 0
removal_time   = 0
native_to      = "Land", "Small Land", "Big Land", "Merchant", "Big Siege"
...
Building roads on river tiles requires knowledge of Bridge Building.\
 City center tiles automatically get roads (even on a river tile).\
")
...
With sufficient technology, you may build magnetic levitation systems\
 along your railroad routes. Land units expend no\
...
Your regular railroads are still used to carry heavy Big Land and\
 Merchant units for which the maglev system is unsuitable, and they\
...
"), _("\
Iron, when found on a Mountain tile, gives 4 more shields.\
...
"), _("\
Game, when found on a Tundra tile, gives 3 more food and 1 more shield.\
 For more information, review the help for the individual tile type.\
")
...
"), _("\
Furs, when found on a Tundra tile, gives 1 more food, 1 more shield, and\
 3 more trade. For more information, review the help for the individual\
 tile type.\
")
...
"), _("\
Spice(s), when found on a Swamp tile, gives 2 more food and 4 more trade.\
 For more information, review the help for the individual tile type.\
")
...
"), _("\
Oil, when found on a Glacier or Desert tile, gives 3 more shields.\
 For more information, review the help for the individual tile types.\
")

# Freeciv(civ1) · buildings

> 来源：longturn/freeciv21
> 原始链接：https://github.com/longturn/freeciv21/blob/main/data/civ1/buildings.ruleset
> 分类：numerical
> 标签：文明, 4X策略, 规则集, civ1

## 概述
Freeciv civ1规则集的buildings定义
...
[datafile]
description="Civ1 buildings data for Freeciv21 (approximate)"
...
; /* xgettext:no-c-format */
helptext	= _("\
With a Barracks II, each new unit built in a city will\
 automatically have Veteran status, which means that its attack and\
 defense strengths are increased by 50%.\
"), _("\
Barracks II also prevent stored food and goods in coastal cities being\
 lost to piracy.\
")
...
; /* xgettext:no-c-format */
helptext	= _("\
With a Barracks III, each new unit built in a city will\
 automatically have Veteran status, which means that its attack and\
 defense strengths are increased by 50%.\
"), _("\
Barracks III also prevent stored food and goods in coastal cities being\
 lost to piracy.\
")
...
Famine can occur when food stock reaches zero due to a food deficit,\
 which a Granary merely delays. A food deficit leads to the loss\
...
Space Structurals form the base of your spaceship. All other\
 spaceship parts need to be connected to Space Structurals in\
 order to function. You can build up to 32 Space Structurals.\
"), _("\
Before you can build any spaceship parts, the Apollo Program wonder\
 must have been built by any player.\
")

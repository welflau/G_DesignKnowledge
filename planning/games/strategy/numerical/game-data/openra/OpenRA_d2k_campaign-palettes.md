# OpenRA(沙丘2000) · campaign-palettes 单位规则

> 来源：OpenRA/OpenRA
> 原始链接：https://github.com/OpenRA/OpenRA/blob/bleed/mods/d2k/rules/campaign-palettes.yaml
> 分类：numerical
> 标签：红色警戒, RTS, 单位属性, YAML规则, 沙丘2000

## 概述
沙丘2000的campaign-palettes单位/建筑属性定义（YAML格式）

# VideoGameDialogueCorpus · 620万词RPG对话语料库说明

> 来源：seannyD/VideoGameDialogueCorpusPublic
> 原始链接：https://correlation-machine.com/VideoGameDialogueCorpus/
> 分类：gameplay
> 标签：语料库, 学术, RPG, 对话数据, 通用
> 游戏类型：通用

## 概述
学术级RPG对话语料库，覆盖26个系列50+款游戏，620万词。含统一的JSON对话格式规范。
...
## 策划参考价值
RPG对话数据的学术级语料库，可用于对话风格分析、角色语言研究、叙事结构对比。
